 ...
 *
 * Usage:
 *   node tools/config-builder.js --config=apexcss.config.js
 *   node tools/config-builder.js --watch
 *
 * Options:
 *   --config    Path to configuration file (default: apexcss.config.js)
...
// Instead, modify your apexcss.config.js and run: npm run config:build
// ============================================================================
...
Options:
  --config=<file>    Config file path (default: apexcss.config.js)
...
async function init() {
  ...
  try {
    ...
    console.log('⚠️  Config file already exists: apexcss.config.js\n');
    return;
  } catch {
  ...
  console.log('✅ Created: apexcss.config.js\n');
